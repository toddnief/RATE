...
dataset_template = {
    ...
    "w_strings": {
        "w=1": "doesn't start with a vowel",
        "w=0": "starts with a vowel",
    ...
    "rewrite_prompt": """{original_completion}\n\nAdjust this review so it {w_counterfactual_string}, but change *nothing* else other than minor changes to retain consistency with your change of the first letter.""",
